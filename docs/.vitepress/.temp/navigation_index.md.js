...
import { defineComponent, computed, resolveComponent, mergeProps, unref, ref, useSSRContext } from "vue";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_image_lazy_load = resolveComponent("image-lazy-load");
      if (svgIcon.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "icon" }, _attrs))}>${svgIcon.value}</div>`);
      } else {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "icon" }, _attrs))}>`);
        if (!_ctx.icon) {
          _push(`<div>${unref(textIcon)}</div>`);
        } else {
          _push(ssrRenderComponent(_component_image_lazy_load, {
            src: _ctx.icon
          }, null, _parent));
        }
        _push(`</div>`);
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("navigation/components/ImageIcon.vue");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (_ctx.link) {
        _push(`<a${ssrRenderAttrs(mergeProps({
          ...
          rel: "noreferrer",
          target: "_blank"
        }, _attrs))} data-v-bf15244c><div class="${ssrRenderClass(unref(ns).e("header"))}" data-v-bf15244c>`);
        _push(ssrRenderComponent(_sfc_main$3, {
          icon: _ctx.icon,
          title: _ctx.title
        }, null, _parent));
        if (_ctx.title) {
          _push(`<h5${ssrRenderAttr("id", formatTitle.value)} class="title" data-v-bf15244c>${ssrInterpolate(_ctx.title)}</h5>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (_ctx.desc) {
          _push(`<p class="${ssrRenderClass(unref(ns).e("footer"))}" data-v-bf15244c>${ssrInterpolate(_ctx.desc)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</a>`);
...
const SiteNavLink_vue_vue_type_style_index_0_scoped_bf15244c_lang = "";
const _sfc_setup$2 = _sfc_main$2.setup;
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("navigation/components/SiteNavLink.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const SiteNavLink = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-bf15244c"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "SiteNavLinkGroup",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      ssrRenderList(unref(NAV_DATA), (group) => {
        _push(`<div class="site-nav-group" data-v-6f45c627>`);
        if (group.title) {
          _push(`<h2${ssrRenderAttr("id", unref(slugify)(group.title))} tabindex="-1" data-v-6f45c627>${ssrInterpolate(group.title)} <a${ssrRenderAttr("aria-label", `Permalink to "${unref(slugify)(group.title)}"`)}${ssrRenderAttr("href", `#${unref(slugify)(group.title)}`)} class="header-anchor" data-v-6f45c627></a></h2>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="site-nav-links" data-v-6f45c627><!--[-->`);
        ssrRenderList(group.items, ({ icon, title, desc, link }) => {
          _push(ssrRenderComponent(SiteNavLink, {
            key: link,
            desc,
            icon,
            link,
...
const SiteNavLinkGroup_vue_vue_type_style_index_0_scoped_6f45c627_lang = "";
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("navigation/components/SiteNavLinkGroup.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const SiteNavLinkGroup = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6f45c627"]]);
const index_scss_vue_type_style_index_0_src_true_lang = "";
const __pageData = JSON.parse('{"title":"导航","description":"","frontmatter":{"title":"导航","layoutClass":"site-nav-layout","outline":[2,3,4],"aside":true,"lastUpdated":false,"editLink":false,"order":1},"headers":[],"relativePath":"navigation/index.md","filePath":"navigation/index.md","lastUpdated":1685354573000}');
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(SiteNavLinkGroup, null, null, _parent));
      _push(`</div>`);
    };
  }
});
