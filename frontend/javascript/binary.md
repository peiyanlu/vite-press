...
| 元素      | 类型化数组             | 字节 | 描述        | 范围                              |
|---------|-------------------|----|-----------|---------------------------------|
| Int8    | Int8Array         | 1  | 8 位有符号整数  | -128 ~ 127                     |
| Uint8   | Uint8Array        | 1  | 8 位无符号整数  | 0 ~ 255                        |
| Uint8C  | Uint8ClampedArray | 1  | 8 位无符号整数  | 0 ~ 255（自动裁剪）                  |
| Int16   | Int16Array        | 2  | 16 位有符号整数 | -32,768 ~ 32,767               |
| Uint16  | Uint16Array       | 2  | 16 位无符号整数 | 0 ~ 65,535                     |
| Int32   | Int32Array        | 4  | 32 位有符号整数 | -2,147,483,648 ~ 2,147,483,647 |
| Uint32  | Uint32Array       | 4  | 32 位无符号整数 | 0 ~ 4,294,967,295              |
| Float32 | Float32Array      | 4  | 32 位浮点    | ~7 位有效数字                       |
| Float64 | Float64Array      | 8  | 64 位浮点    | ~16 位有效数字                      |
