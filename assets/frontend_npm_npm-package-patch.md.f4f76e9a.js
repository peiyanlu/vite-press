import{_ as s,j as a,k as n,S as e}from"./chunks/framework.6b5081d6.js";const C=JSON.parse('{"title":"NPM包重新打包","description":"","frontmatter":{"title":"NPM包重新打包","tags":["NPM","patch"]},"headers":[],"relativePath":"frontend/npm/npm-package-patch.md","filePath":"frontend/npm/npm-package-patch.md","lastUpdated":1684487737000}'),l={name:"frontend/npm/npm-package-patch.md"},p=e(`<h1 id="依赖包重新打包" tabindex="-1">依赖包重新打包 <a class="header-anchor" href="#依赖包重新打包" aria-label="Permalink to &quot;依赖包重新打包&quot;">​</a></h1><h2 id="设置package-json" tabindex="-1">设置package.json <a class="header-anchor" href="#设置package-json" aria-label="Permalink to &quot;设置package.json&quot;">​</a></h2><div class="language-json line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">{</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">package-name+0.44.0.dev.patch</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div>`,14),r=[p];function c(i,o,t,b,m,d){return a(),n("div",null,r)}const y=s(l,[["render",c]]);export{C as __pageData,y as default};
