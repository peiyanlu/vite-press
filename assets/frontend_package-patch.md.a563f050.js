import{_ as s,c as n,o as a,d as p}from"./app.004d8197.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/package-patch.md","lastUpdated":1667987221000}'),l={name:"frontend/package-patch.md"},e=p(`<p>###\u4F9D\u8D56\u5305\u91CD\u65B0\u6253\u5305</p><p>######\u8BBE\u7F6Epackage.json</p><div class="language-json line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki"><code><span class="line"><span style="color:#C9D1D9;">{</span></span>
