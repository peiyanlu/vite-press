import{_ as s,c as n,o as a,a as e}from"./app.2516fd24.js";const A=JSON.parse('{"title":"依赖包重新打包","description":"","frontmatter":{},"headers":[{"level":2,"title":"设置package.json","slug":"设置package-json","link":"#设置package-json","children":[]},{"level":2,"title":"1、安装依赖","slug":"_1、安装依赖","link":"#_1、安装依赖","children":[]},{"level":2,"title":"2、修改依赖包","slug":"_2、修改依赖包","link":"#_2、修改依赖包","children":[]},{"level":2,"title":"3、创建补丁","slug":"_3、创建补丁","link":"#_3、创建补丁","children":[]},{"level":2,"title":"4、应用补丁","slug":"_4、应用补丁","link":"#_4、应用补丁","children":[]},{"level":2,"title":"Dev-only","slug":"dev-only","link":"#dev-only","children":[]}],"relativePath":"frontend/package-patch.md","lastUpdated":1669197850000}'),l={name:"frontend/package-patch.md"},p=e(`<h1 id="依赖包重新打包" tabindex="-1">依赖包重新打包 <a class="header-anchor" href="#依赖包重新打包" aria-hidden="true">#</a></h1><h2 id="设置package-json" tabindex="-1">设置package.json <a class="header-anchor" href="#设置package-json" aria-hidden="true">#</a></h2><div class="language-json line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki"><code><span class="line"><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h2 id="_2、修改依赖包" tabindex="-1">2、修改依赖包 <a class="header-anchor" href="#_2、修改依赖包" aria-hidden="true">#</a></h2><div class="language-javascript line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki"><code><span class="line"><span style="color:#676E95;">// javascript code</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div>`,14),c=[p];function r(o,i,t,b,d,C){return a(),n("div",null,c)}const y=s(l,[["render",r]]);export{A as __pageData,y as default};
