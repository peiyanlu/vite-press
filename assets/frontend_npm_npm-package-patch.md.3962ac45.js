import{_ as s,o as a,c as n,R as e}from"./chunks/framework.9eb963cb.js";const C=JSON.parse('{"title":"依赖包重新打包","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/npm/npm-package-patch.md","filePath":"frontend/npm/npm-package-patch.md","lastUpdated":1680688772000}'),l={name:"frontend/npm/npm-package-patch.md"},p=e(`<h1 id="依赖包重新打包" tabindex="-1">依赖包重新打包 <a class="header-anchor" href="#依赖包重新打包" aria-label="Permalink to &quot;依赖包重新打包&quot;">​</a></h1><h2 id="设置package-json" tabindex="-1">设置package.json <a class="header-anchor" href="#设置package-json" aria-label="Permalink to &quot;设置package.json&quot;">​</a></h2><div class="language-json line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">{</span></span>
